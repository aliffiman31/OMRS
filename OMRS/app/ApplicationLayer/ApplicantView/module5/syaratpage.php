...
<section>
        ...
        <div class="content-container">
            <div class="content">
                ...
                <h1 class="syarattitle">SYARAT KELAYAKAN INSENTIF KHAS PASANGAN PENGANTIN YANG <br>BERDAFTAR DI NEGERI PAHANG</h1>
            <p class="syaratp">Insentif ini disediakan untuk pasangan yang pengantin 
              lelakinya berpendapatan RM5000.00 dan ke bawah tertakluk 
              kepada syarat-syarat dan garis panduan yang ditentukan.</p>
              <ul class="syaratlist">
              ...
              <p class="syaratp">ANDA <strong>TIDAK LAYAK</strong> SEKIRANYA :-</p>
              <ul class="syaratlist">
                  <li>Poligami</li>
              ...
              <p class="syaratp">DOKUMEN SOKONGAN YANG PERLU DIMUAT NAIK</p>
              <ul class="syaratlist">
              ...
              <p class="contact"><strong>HUBUNGI KAMI :</strong>
              <br>Bahagian Undang-Undang Keluarga Islam Pahang
              <br>Jabatan Agama Islam Pahang
              <br>Tel : 09-42711111</p>
                </div>
            </div>
        </div>
</section>
